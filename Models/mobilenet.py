...
class MobileNet(nn.Module):
    ...
    def __init__(self, width_multiplier=1, class_num=100, input_channel=1):
       super().__init__()

       alpha = width_multiplier
       self.stem = nn.Sequential(
           BasicConv2d(input_channel, int(32 * alpha), 3, padding=1, bias=False),
...
def mobilenet(input_channels, alpha=1, class_num=100):
    return MobileNet(alpha, class_num, input_channels)


if __name__ == '__main__':
    x1 = torch.randn(64, 3, 32, 32)
    x2 = torch.randn(64, 1, 28, 28)
    net1 = mobilenet(3, class_num=10)
