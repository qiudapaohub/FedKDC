...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, input_channels, class_num=10):
        super().__init__()

        self.pre = nn.Sequential(
            nn.Conv2d(input_channels, 32, 1, padding=1),
            nn.BatchNorm2d(32),
            nn.ReLU6(inplace=True)
        )
...
def mobilenetv2(input_channels, class_num=10):
    return MobileNetV2(input_channels, class_num=class_num)


if __name__ == '__main__':
    x1 = torch.randn(64, 3, 32, 32)
    x2 = torch.randn(64, 1, 28, 28)
    net1 = mobilenetv2(3, class_num=10)
    net2 = mobilenetv2(1, class_num=10)
    a, b, c = net1(x1, t=4)
