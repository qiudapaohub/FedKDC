...
class MobileNetV2(nn.Module):
    def __init__(self, input_channel, output_size, alpha=1):
        super(MobileNetV2, self).__init__()
        self.output_size = output_size

        # first conv layer
        self.conv0 = nn.Conv2d(input_channel, int(32*alpha), kernel_size = 3, stride = 1, padding = 1, bias = False)
...
def mobilenetv2(input_channels, output_size=10):
    return MobileNetV2(input_channels, output_size)


if __name__ == '__main__':
    x1 = torch.randn(64, 3, 32, 32)
    net1 = mobilenetv2(3, output_size=10)
    a, b, c = net1(x1, t=4)
