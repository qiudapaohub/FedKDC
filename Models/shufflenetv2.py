...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, input_channel, ratio=1, class_num=100):
        super().__init__()
        if ratio == 0.5:
        ...
        self.pre = nn.Sequential(
            nn.Conv2d(input_channel, 24, 3, padding=1),
            nn.BatchNorm2d(24)
        )
...
def shufflenetv2(input_channel, class_num=10):
    return ShuffleNetV2(input_channel, class_num=class_num)
